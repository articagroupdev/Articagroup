...
export default function Navbar() {
  ...
  return (
    <nav
      ref={navRef}
      className="fixed top-0 left-0 right-0 z-[9997] px-2 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-3 md:py-4 transition-all duration-300 bg-white lg:bg-transparent shadow-sm lg:shadow-none"
    >
              ...
              >
                <div className="grid grid-cols-3 gap-x-6 gap-y-3">
                  ...
                  <div className="space-y-3">
                    ...
                    <a href="#servicio-diseno" className="block shadow-none" style={{ boxShadow: 'none', textDecoration: 'none', textShadow: 'none' }}>
                      <div className="flex items-center justify-center w-10 h-10 rounded-lg border-2 border-[#13B9D5] mb-2 shadow-none" style={{ boxShadow: 'none' }}>
                        <svg className="w-5 h-5 text-[#13B9D5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#servicio-estrategia" className="block shadow-none" style={{ boxShadow: 'none' }}>
                      <div className="flex items-center justify-center w-10 h-10 rounded-lg border-2 border-[#13B9D5] mb-2 shadow-none" style={{ boxShadow: 'none' }}>
                        <svg className="w-5 h-5 text-[#13B9D5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Columna 2 */}
                  <div className="space-y-3">
                    <a href="#servicio-video" className="block shadow-none" style={{ boxShadow: 'none' }}>
                      <div className="flex items-center justify-center w-10 h-10 rounded-lg border-2 border-[#13B9D5] mb-2 shadow-none" style={{ boxShadow: 'none' }}>
                        <svg className="w-5 h-5 text-[#13B9D5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#servicio-publicidad" className="block shadow-none" style={{ boxShadow: 'none' }}>
                      <div className="flex items-center justify-center w-10 h-10 rounded-lg border-2 border-[#13B9D5] mb-2 shadow-none" style={{ boxShadow: 'none' }}>
                        <svg className="w-5 h-5 text-[#13B9D5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="space-y-3">
                    ...
                    <a href="#servicio-ads" className="block shadow-none" style={{ boxShadow: 'none' }}>
                      <div className="flex items-center justify-center w-10 h-10 rounded-lg border-2 border-[#13B9D5] mb-2 shadow-none" style={{ boxShadow: 'none' }}>
                        <svg className="w-5 h-5 text-[#13B9D5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#servicio-community" className="block shadow-none" style={{ boxShadow: 'none' }}>
                      <div className="flex items-center justify-center w-10 h-10 rounded-lg border-2 border-[#13B9D5] mb-2 shadow-none" style={{ boxShadow: 'none' }}>
                        <svg className="w-5 h-5 text-[#13B9D5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
